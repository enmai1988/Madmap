...
-- INSERT INTO mad_map_markers (lat, lng, icon, info, map_id) VALUES ('50, -129, some info about our pin, 1');
-- INSERT INTO mad_map_markers (lat, lng, icon, info, map_id) VALUES ('42, -118, random string describing pin, 2');
-- INSERT INTO mad_map_markers (lat, lng, icon, info, map_id) VALUES ('40, -108, random string thats working, 3');
